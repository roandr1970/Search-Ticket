...
class TicketManagerTest {
    ...
    Ticket second = new Ticket(1, "DME", "ODD", 14000, 3);
    ...
    @Test
    public void shouldSearchByThreeTicket() {
    ...
    @Test
    public void shouldSearchByOneTicked() {
    ...
    @Test
    public void shouldSearchByNoTicked() {

        Ticket[] actual = manager.searchBy("DME", "SMA");
